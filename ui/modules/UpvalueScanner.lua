...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/ProtonDev-sys/Hydroxide/tree/potassium-modernization-fork

local function ohHttpGet(url)
    if request then
...
local aux = loadstring(ohHttpGet("https://raw.githubusercontent.com/ProtonDev-sys/Hydroxide/potassium-modernization-fork/ohaux.lua"))()
